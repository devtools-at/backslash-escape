...
<p align="center">
  <a href="https://devtools.at/tools/backslash-escape"><img src="https://img.shields.io/badge/Try%20Online-DevTools.at-blue?style=for-the-badge" alt="Try Online"></a>
...
<p align="center">
  <b>Escape/unescape backslash sequences</b>
</p>

<p align="center">
  <a href="https://devtools.at/tools/backslash-escape">Try Online</a> •
...
**[Try Backslash Escape online at DevTools.at →](https://devtools.at/tools/backslash-escape)**
...
## What is Backslash Escape?

Escape/unescape backslash sequences. This is a standalone TypeScript/JavaScript implementation that you can use in your own projects.
...
```typescript
import { process } from '@devtools-at/backslash-escape';
